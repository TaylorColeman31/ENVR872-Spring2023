...
How would you store it in another object?
...
## Transforming an object in a data frame
...
summary(df)
head(df) #show the first 6 rows of df (6 is the default, if you want 10 for example, specify using 'head (df, 10)')
