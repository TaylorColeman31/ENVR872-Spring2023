...
NTL.phys.data.irradiance <- 
  NTL.phys.data %>%
  pivot_longer(irradianceDeck:irradianceWater, names_to = "irradiance type", values_to = "irradiance values")

#Exercise 6: Spread temperatureC into more than one column based on the depth. "names_from" specifies the column names from the desired variable; "values_from" specifies row values!
NTL.phys.data.temp.depth <-
  NTL.phys.data %>%
