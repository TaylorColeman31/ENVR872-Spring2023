...
O3.onesample
# Conclusion: Reject H0, population mean < 50
...
> Most of the observations and the mean exist to the left of the null hypothesis's assumption that the mean is equal to 50. The p-value reported from our "onesample" t-test confirms this. 
...
# Conclusions: Mean ozone concentration values are different between 2018 and 2019, and there is statistical significance behind using year as a predictor of ozone levels.   
```
