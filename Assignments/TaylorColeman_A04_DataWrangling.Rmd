...
# Converting Date column from factor to date variable
EPAair_O3_PM25_NC1819$Date <- as.Date(EPAair_O3_PM25_NC1819$Date, format = "%m/%d/%Y")

#8 Using pipe function to wrangle new combined dataset filtering common sites, 
#generating daily means for AQIs, latitude, and longitude values, and adding columns for month and year.
...
#AQI values
EPAair_O3_PM25_NC1819_Spread <- spread(EPAair_O3_PM25_NC1819_Wrangled, AQS_PARAMETER_DESC, mean_daily_AQI)

#10 Calling the dimensions of the new dataset: Returns 8,029 rows x 9 columns
dim(EPAair_O3_PM25_NC1819_Spread)

#11 Saving processed dataset
write.csv(EPAair_O3_PM25_NC1819_Spread, row.names = FALSE, file = "Data/Processed/EPAair_PM25_NC2019_Processed.csv")
```
